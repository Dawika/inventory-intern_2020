describe 'Vacation Leave Rules', js: true do
  ...
  let!(:vacation_leave_rules) {
    VacationLeaveRule.create!({
      ...
      message: """
        ...
        &nbsp;
        <p>- ต้องลาล่วงหน้าอย่างน้อย 3 วัน เป็นลายลักษณ์อักษร ทาง Banana Vacation (<a href='http://vacation.bananacoding.com'>http://vacation.bananacoding.com</a>), email </p>
        ...
        &nbsp;
        <p>- ทำงานนอกสถานที่ หรือ ที่บ้าน สามารถทำได้ 2 วันต่อสัปดาห์ ต้องแจ้ง ทาง Banana Vacation (<a href='http://vacation.bananacoding.com'>http://vacation.bananacoding.com</a>), email </p>
        &nbsp;
  ...
  it 'employee should see leave rule' do
    ...
    expect(page).to have_content("- ต้องลาล่วงหน้าอย่างน้อย 3 วัน เป็นลายลักษณ์อักษร ทาง Banana Vacation (http://vacation.bananacoding.com), email ")
    ...
    expect(page).to have_content("- ทำงานนอกสถานที่ หรือ ที่บ้าน สามารถทำได้ 2 วันต่อสัปดาห์ ต้องแจ้ง ทาง Banana Vacation (http://vacation.bananacoding.com), email ")
    expect(page).to have_content("- ทำงานนอกสถานที่ หรือ ที่บ้าน สามารถทำได้ 2 วันต่อสัปดาห์ ต้องแจ้ง ทาง Banana Vacation (http://vacation.bananacoding.com), email ")
