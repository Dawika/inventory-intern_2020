...
$(document).ready(function() {
    ...
    var fieldHTML = '<div id = "form_grade"> <div class="row"><div class="col-md-11"><input type="text" name="grades[name][]" class="form-control" placeholder = "กรุณากรอกชื่อชั้นเรียน"/></div><div class="col-md-1"><a href="javascript:void(0);" class="remove_button"><img src="/remove-icon.png" height="100%" width="100%"  style="margin-top: 36%;margin-left: -30%;" "/></a></div></div><br></div>'; //New input field html 
    ...
    $(wrapper).on('click', '.remove_button', function(e) {
        e.preventDefault();
        $(this).parents('#form_grade').remove(); //Remove field html
